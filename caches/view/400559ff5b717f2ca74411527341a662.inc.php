...
if(obj.percent == 100){
$('.next').removeAttr("disabled").removeClass('agree-btn disabled').addClass('agree-btn3').text('完成安装').attr('href','index.php?m=install&c=index&a=setup4&admin_user='+obj.admin_user);
}
}
</script>
<?php
