 ...
 *      tel:400-600-2042
 */
class mobile_address_service extends service
{
	...
	public function add($params = array()) {
		...
		if(!$this->_validate($params)) {
			return array("status"=>0,"error"=>$this->error); 
		}
		/* 校验发布条数 */
		...
		return array("status"=>1,"datas"=>array("address_id"=>$result)); ;
	}
	...
	public function edit($params = array()) {
		...
		return array("status"=>1,"datas"=>array("msg"=>"修改成功")); 
	}
